...
layui.define(["jquery", "miniMenu", "element", "miniTab", "miniTheme"], function (exports) {
    ...
    var miniAdmin = {
         ...
         */
        renderLogo: function () {
            var html = '<a href="/"><img src="/img/logo.png" alt="logo"><h1>watermark</h1></a>';
         ...
         */
        renderHome: function () {
            sessionStorage.setItem('layuiminiHomeHref', "");
            $('#layuiminiHomeTabId').html('<span class="layuimini-tab-active"></span><span class="disable-close">首页</span><i class="layui-icon layui-unselect layui-tab-close">ဆ</i>');
            $('#layuiminiHomeTabId').attr('lay-id', "");
            $('#layuiminiHomeTabIframe').html('<iframe width="100%" height="100%" frameborder="no" border="0" marginwidth="0" marginheight="0"  src=""></iframe>');
        },
